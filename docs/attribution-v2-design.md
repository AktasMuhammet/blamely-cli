...
| §12 soak measurement (`blamely attribution-status`) | ✅ | dual-run divergence persisted per commit (.git/blamely/v2-divergence.jsonl) + summarized; makes the Phase 6 gate measurable |
